...
const report={mode,id,commit,previous:live.id,url:'https://'+id+'--tree-token.netlify.app',files:Object.keys(files).length,functionsPreserved:live.available_functions.length,schedulesPreserved:live.function_schedules.length,productionChanged:mode==='promote'};
