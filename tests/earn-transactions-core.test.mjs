...
import {
  SUI_TYPE, TREE_TYPE, V2_FARM, V2_POOL, V2_REWARD_VAULT, V2_EMISSION_CONFIG, V2_LP_TYPE, VICTORY_TYPE,
  buildV2ClaimRewardsTransaction, buildV2StakeTransaction, buildV2ZapTransaction, extractPositiveV2VictoryReward,
  estimateV2PositionUnderlying, getV2FarmPosition, minimumAfterSlippage, parseAmount, validateV2Quote,
...
console.log('Earn transaction core: PASS (V2 zap, stake, VICTORY claim builder, and verified reward extraction)');
